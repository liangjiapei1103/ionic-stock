...
.constant('FIREBASE_URL', 'https://jiapei-ionic-stock.firebaseio.com/')
...
.factory('userService', function($rootScope, $window, $timeout, firebaseRef, firebaseUserRef, myStocksArrayService, myStocksCacheService, modalService, notesCacheService) {
...
.factory('chartDataService', ['$q', '$http', 'encodeURIService', 'chartDataCacheService',
    function($q, $http, encodeURIService, chartDataCacheService) {
